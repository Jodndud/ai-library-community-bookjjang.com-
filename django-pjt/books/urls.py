...
urlpatterns = [
    ...
    path(
        "<int:pk>/", book_views.book_detail, name="book-detail"
    ...
    path(
        "<int:book_pk>/threads/<int:pk>/",
        thread_views.thread_detail,
        name="thread-detail",
    ),  # GET 상세
    path(
        "<int:book_pk>/threads/<int:pk>/comments/",
        thread_views.comment_list_create,
