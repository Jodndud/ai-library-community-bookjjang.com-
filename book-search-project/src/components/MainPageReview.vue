  ...
  <div class="main-page-section">
    ...
    <ul class="review-item">
      <li v-for="review in reviewStore.reviews" :key="review.id">
        <router-link class="review" :to="{ name: 'reviewDetail', params: { reviewId: review.pk } }">
          <div class="img"><img :src="review.fields.cover_image" alt="cover" class="cover-image" /></div>
          <div class="hover-content">
            <div class="book-title">{{ review.fields.title }}</div>
